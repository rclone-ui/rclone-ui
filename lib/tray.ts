...
import { PhysicalPosition, PhysicalSize, getAllWindows } from '@tauri-apps/api/window'
...
const trayPosition = new PhysicalPosition(0, 0)
const traySize = new PhysicalSize(0, 0)
